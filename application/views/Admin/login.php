...
<head>
        ...
        <link rel="stylesheet" href="\parish\assets\HTML\css\matrix-login.css" />
    ...
    <body>
        <div id="loginbox">            
            <form id="loginform" method="post" class="form-vertical">
				 <div class="control-group normal_text"> <h3><img src="\parish\assets\HTML\img\logo.png" alt="Logo" /></h3></div>
                ...
                <div class="form-actions">
                    ...
                    <span class="pull-right"><input class="btn btn-success" type="submit" name="login" value="LOGIN" ><br/></span>
                </div>
            </form>
        ...
        <script src="\parish\assets\HTML\js\matrix.login.js"></script> 
    </body>
